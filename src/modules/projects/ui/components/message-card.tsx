...
const FragmentCard = ({
  ...
  return (
    <button
      className={cn(
        "flex items-start gap-2 border rounded-lg bg-muted w-fit p-2 hover:bg-secondary transition-colors",
        isActiveFragment &&
          "bg-primary text-primary-foreground border-primary hover:bg-primary"
      )}
      onClick={() => onFragmentClick(fragment)}
    >
      <Code2Icon className="siz-4 mt-0.5" />
    ...
    >
      ...
      <div className="pl-8.5 flex flex-col gap-y-4">
        ...
        {fragment && type === "RESULT" && (
          <FragmentCard
            fragment={fragment}
            isActiveFragment={isFragmentActive}
